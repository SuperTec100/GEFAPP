  ...
  if (button) {
    ...
    if (confirm(`Deseja realmente remover o paciente do Leito ${leito}?`)) {
      try {
        ...
        console.log("Paciente excluído do banco de dados.");
        button.closest('li').remove();
        console.log("Paciente removido da tela.");
      } catch (error) {
        console.error("Erro ao excluir paciente:", error);
        alert('Erro ao excluir paciente. Veja o console.');
      }
    }
  }
});
